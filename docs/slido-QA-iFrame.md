...
<div>
    ...
    <div style="position: relative; height: 600px; width: 100%; overflow: hidden; border: 2px solid #1b8039; border-radius: 10px">
      <iframe src="https://app.sli.do/event/bvokvk8ANxFWr3PJUmZxHw/questions" height="700px" width="100%" frameBorder="0" style="min-height: 560px; display: inline-block; margin-top: -100px"></iframe>
